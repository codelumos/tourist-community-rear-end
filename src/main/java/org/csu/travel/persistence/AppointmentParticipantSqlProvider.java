...
import org.csu.travel.domain.AppointmentParticipantExample.Criteria;
import org.csu.travel.domain.AppointmentParticipantExample.Criterion;
...
public class AppointmentParticipantSqlProvider {
    ...
    public String countByExample(AppointmentParticipantExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(AppointmentParticipantExample example) {
        BEGIN();
        DELETE_FROM("appointment_participant");
        applyWhere(example, false);
        return SQL();
    }
    ...
    public String selectByExample(AppointmentParticipantExample example) {
        BEGIN();
    ...
    protected void applyWhere(AppointmentParticipantExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
